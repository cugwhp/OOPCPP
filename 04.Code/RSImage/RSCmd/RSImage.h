...
protected:
	...
	int	CalcStatistics(double* dpMin=NULL,double* dpMax=NULL,double* dpMean=NULL,double* dpVar=NULL);//计算统计量，以波段为单位

	void	Conv(double* dFilterKernel, int nSize);	//图像滤波

	//显示图像 Add by 2017.12.11
